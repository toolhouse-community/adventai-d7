# Hello AdventAI - Day 7️⃣

![Banner](repository-assets/banner.png)

[![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d7&owner=%40me&name=th-adventai-d7&description=AdventAI+Day+7+Fork&visibility=public)

## Table of Contents

- [Hello AdventAI - Day 7️⃣](#hello-adventai---day-7️⃣)
...
![Screengrab](repository-assets/facts_screen.gif)

On Day 7️⃣, we are unwrapping a daily facts app that based on your preferences, sends you email notifications with new facts.

What the app does:

- **Daily Email Digest**: Delivers a curated collection of new facts based on your preferences daily.

> [!NOTE]
> This app requires the `send_email`, `memory_fetch`, `memory_store`, `memory_delete` and `current_time` tools.
...
- [![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d7&owner=%40me&name=th-adventai-d7&description=AdventAI+Day+7+Fork&visibility=public)
  ...
  Or Create a [Fork](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d7&owner=%40me&name=th-project&description=AdventAI+Day+7+Fork&visibility=public)
...
```bash
git clone https://github.com/{USERNAME}/adventai-d7/
cd adventai-d7
```
...
[Back to Top ⬆️](#hello-adventai---day-7️⃣)
